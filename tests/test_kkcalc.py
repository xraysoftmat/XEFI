...
class TestKKCalcIntegration:
    ...
    @pytest.mark.parametrize("func,test",
                             [(XEF_Basic, base_rough_attributes_defined), (XEF_Sliced, sliced_attributes_defined)])
    def test_kkcalc_integration(self, func, test):
        ...
        refractive_indices = [
            ...
            kk.models.asp_db_complex(MATERIALS["Si"]["formula"], density=MATERIALS["Si"]["density"]), # Si, g/cm^3
        ]
