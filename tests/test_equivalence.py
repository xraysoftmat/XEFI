...
import pytest
from XEFI import XEF_method, XEF_Basic, XEF_Sliced
...
class TestEquivalence:
    ...
    @pytest.mark.parametrize("energy, thickness, angle", [
    ...
    def test_model_equivalence(self, energy, thickness, angle):
        ...
        refractive_indices: list[kk.models.asp_complex] = [
            kk.models.asp_db_complex(MATERIALS["Air"]["formula"], density=MATERIALS["Air"]["density"]), # Air
            kk.models.asp_db_complex(MATERIALS["P3HT"]["formula"], density=MATERIALS["P3HT"]["density"]), # P3HT
            kk.models.asp_db_complex(MATERIALS["Si"]["formula"], density=MATERIALS["Si"]["density"]), # Si
        ]
        ...
        assert ave_perc_diff < 10, f"Average percentage difference is too high: {ave_perc_diff:.2f}%"